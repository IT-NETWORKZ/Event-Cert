...
// Injecting the skeleton shimmer keyframes into the document head dynamically 
// so you don't have to fiddle with external CSS configuration files.
...
// Lazy Image Component with Shimmer Skeleton UI
const LazyImage = ({ src, alt, onClick, style, onMouseOver, onMouseOut }) => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      {
        root: null, 
        rootMargin: "120px", // Starts downloading slightly ahead of time
      }
    );
